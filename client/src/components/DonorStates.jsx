...
export default function DonarStats() {
  ...
  return (
    <section className="mt-8 grid grid-cols-2 gap-4">
      <Link
        href="/donors"
        className="bg-background hover:bg-hover group rounded-2xl p-6 text-center shadow">
        {/* Total Donors */}
        ...
        <p className="text-3xl scaled font-bold text-secondary">
          {user.length}
        </p>
        <p className="text-primary scaled mt-1">Total Donors</p>
      </Link>

      {/* Available Donors Now */}
      <div className="bg-background hover:bg-hover group rounded-2xl p-6 text-center shadow">
        ...
        <p className="text-3xl scaled font-bold text-secondary">{user.filter((u) => u.isEligible).length}</p>
        <p className="text-primary scaled mt-1">Eligible Now</p>
      </div>
    </section>
  );
}
