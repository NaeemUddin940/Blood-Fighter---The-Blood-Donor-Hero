...
export default function AllDonerAndStatistics() {
  return (
    <section className="mt-8 mb-20 grid grid-cols-2 gap-4">
      <Link
        href="/donors"
        className="bg-gray-50 hover:bg-gray-100 group rounded-2xl cursor-pointer p-6 text-center shadow flex flex-col items-center">
